...
//			deleteAllStudents(studentDAO);
	...
	private void deleteAllStudents(StudentDAO studentDAO) {
		...
		System.out.println("Deleted rows count: "+ numsRowsDeleted);
	}
	...
	private void retrieveStudent(StudentDAO studentDAO) {
		...
		Student tempStudent = new Student("John", "Doe", "john@buildwithkumar.com");
		...
		//retrieve student based on that id
